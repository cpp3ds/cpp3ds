...
namespace
{
    ...
    cpp3ds::Vector2f computeNormal(const cpp3ds::Vector2f& p1, const cpp3ds::Vector2f& p2)
    {
        cpp3ds::Vector2f normal(p1.y - p2.y, p2.x - p1.x);
    ...
    float dotProduct(const cpp3ds::Vector2f& p1, const cpp3ds::Vector2f& p2)
    {
