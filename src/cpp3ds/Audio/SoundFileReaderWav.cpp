...
namespace
{
    ...
    bool decode(cpp3ds::InputStream& stream, cpp3ds::Uint8& value)
    {
         return stream.read(&value, sizeof(value)) == sizeof(value);
    }

    bool decode(cpp3ds::InputStream& stream, cpp3ds::Int16& value)
    {
    ...
    bool decode(cpp3ds::InputStream& stream, cpp3ds::Uint16& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    bool decode(cpp3ds::InputStream& stream, cpp3ds::Int32& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    bool decode(cpp3ds::InputStream& stream, cpp3ds::Uint32& value)
    {
        unsigned char bytes[sizeof(value)];
        if (stream.read(bytes, sizeof(bytes)) != sizeof(bytes))
            return false;
    ...
    const cpp3ds::Uint64 mainChunkSize = 12;
}
