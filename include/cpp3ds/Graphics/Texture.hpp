...
#ifndef CPP3DS_TEXTURE_HPP
#define CPP3DS_TEXTURE_HPP
...
public :
    ...
    ///
    /// \code
    /// cpp3ds::Texture t1, t2;
    /// ...
    /// cpp3ds::Texture::bind(&t1);
    /// // draw OpenGL stuff that use t1...
    /// cpp3ds::Texture::bind(&t2);
    /// // draw OpenGL stuff that use t2...
    /// cpp3ds::Texture::bind(NULL);
...
/// \ingroup graphics
///
/// cpp3ds::Texture stores pixels that can be drawn, with a sprite
...
/// A texture cannot be manipulated as freely as a cpp3ds::Image,
/// you need to prepare the pixels first and then upload them
/// to the texture in a single operation (see Texture::update).
///
/// cpp3ds::Texture makes it easy to convert from/to cpp3ds::Image, but
...
/// cpp3ds::Image, do whatever you need with the pixels, and then call
...
/// of booleans.
///
/// Like cpp3ds::Image, cpp3ds::Texture can handle a unique internal
/// representation of pixels, which is RGBA 32 bits. This means
/// that a pixel must be composed of 8 bits red, green, blue and
/// alpha channels -- just like a cpp3ds::Color.
///
/// Usage example:
/// \code
/// // This example shows the most common use of cpp3ds::Texture:
/// // drawing a sprite
///
...
///
/// \code
/// // This example shows another common use of cpp3ds::Texture:
...
///
///     // update the texture
///     cpp3ds::Uint8* pixels = ...; // get a fresh chunk of pixels (the next frame of a movie, for example)
...
/// \endcode
///
/// Like cpp3ds::Shader that can be used as a raw OpenGL shader,
/// cpp3ds::Texture can also be used directly as a raw texture for
/// custom OpenGL geometry.
/// \code
/// cpp3ds::Texture::bind(&texture);
/// ... render OpenGL geometry ...
/// cpp3ds::Texture::bind(NULL);
/// \endcode
///
/// \see cpp3ds::Sprite, cpp3ds::Image, cpp3ds::RenderTexture
///
////////////////////////////////////////////////////////////
