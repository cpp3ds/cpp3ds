...
#ifndef CPP3DS_TRANSFORMABLE_HPP
#define CPP3DS_TRANSFORMABLE_HPP
...
/// \ingroup graphics
///
/// This class is provided for convenience, on top of cpp3ds::Transform.
///
/// cpp3ds::Transform, as a low-level class, offers a great level of
...
///
/// That's exactly what cpp3ds::Transformable was written for: it hides
...
/// transform (as a cpp3ds::Transform), and keeps it up-to-date.
///
/// In addition to the position, rotation and scale, cpp3ds::Transformable
...
/// bottom-right corner.
///
/// To keep the cpp3ds::Transformable class simple, there's only one
...
///     }
///
///     void Draw(cpp3ds::RenderTarget& target) const
///     {
///         target.draw(..., myTransform.getTransform());
///     }
///
/// private :
///     cpp3ds::Transformable myTransform;
/// };
/// \endcode
///
...
/// In order to render a cpp3ds::Drawable object pixel-perfectly, make sure
