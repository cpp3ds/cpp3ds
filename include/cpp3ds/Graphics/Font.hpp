...
#ifndef CPP3DS_FONT_HPP
#define CPP3DS_FONT_HPP
...
////////////////////////////////////////////////////////////
    ...
    public:
        ...
        /// load them directly.
        ///
        /// \warning cpp3ds cannot preload all the font data in this
        /// function, so the file has to remain accessible until
        /// the cpp3ds::Font object loads a new font or is destroyed.
        ///
        ...
        /// valid until the cpp3ds::Font object loads a new font or
        /// is destroyed.
        ///
        ...
        /// used internally by cpp3ds::Text.
        ///
        /// \param characterSize Reference character size
        ///
...
///
/// Once it is loaded, a cpp3ds::Font instance provides three
...
/// use the cpp3ds::Text class, which is able to properly output text
/// with several options such as character size, style, color,
/// position, rotation, etc.
/// This separation allows more flexibility and better performances:
/// indeed a cpp3ds::Font is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a cpp3ds::Text is a lightweight object which can combine the
/// glyphs data and metrics of a cpp3ds::Font to display any text on a
/// render target.
/// Note that it is also possible to bind several cpp3ds::Text instances
/// to the same cpp3ds::Font.
///
...
/// text1.setStyle(cpp3ds::Text::Regular);
///
/// // Create another text using the same font, but with different parameters
/// cpp3ds::Text text2;
/// text2.setFont(font);
/// text2.setCharacterSize(50);
/// text2.setStyle(cpp3ds::Text::Italic);
/// \endcode
///
/// Apart from loading font files, and passing them to instances
/// of cpp3ds::Text, you should normally not have to deal directly
/// with this class. However, it may be useful to access the
/// font metrics or rasterized glyphs for advanced usage.
///
/// Note that if the font is a bitmap font, it is not scalable,
/// thus not all requested sizes will be available to use. This
/// needs to be taken into consideration when using cpp3ds::Text.
