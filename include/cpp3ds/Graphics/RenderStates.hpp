...
public :
    ...
    /// to using cpp3ds::RenderStates::Default.
...
/// function: cpp3ds::RenderStates has an implicit one-argument
...
/// object (inherited from cpp3ds::Drawable), you can
...
/// set its texture. Etc.
///
/// \see cpp3ds::RenderTarget, cpp3ds::Drawable
///
////////////////////////////////////////////////////////////
