...
#ifndef CPP3DS_RECT_HPP
#define CPP3DS_RECT_HPP
...
/// (Vector2 and Vector3).
///
/// To keep things simple, cpp3ds::Rect doesn't define
/// functions to emulate the properties that are not directly
/// members (such as right, bottom, center, etc.), it rather
/// only provides intersection functions.
///
/// cpp3ds::Rect uses the usual rules for its boundaries:
/// \li The left and top edges are included in the rectangle's area
/// \li The right (left + width) and bottom (top + height) edges are excluded from the rectangle's area
///
/// This means that cpp3ds::IntRect(0, 0, 1, 1) and cpp3ds::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// cpp3ds::Rect is a template and may be used with any numeric type, but
/// for simplicity the instanciations used by SFML are typedefed:
/// \li cpp3ds::Rect<int> is cpp3ds::IntRect
/// \li cpp3ds::Rect<float> is cpp3ds::FloatRect
///
...
/// cpp3ds::IntRect r1(0, 0, 20, 5);
///
/// // Define another rectangle, located at (4, 2) with a size of 18x10
/// cpp3ds::Vector2i position(4, 2);
/// cpp3ds::Vector2i size(18, 10);
/// cpp3ds::IntRect r2(position, size);
///
