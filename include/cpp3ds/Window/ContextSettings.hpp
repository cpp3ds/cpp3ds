...
#ifndef CPP3DS_CONTEXTSETTINGS_HPP
#define CPP3DS_CONTEXTSETTINGS_HPP
...
{
////////////////////////////////////////////////////////////
/// \brief Enumeration of the two screen to which contexts can draw
///
////////////////////////////////////////////////////////////
enum Screen
{
...
struct ContextSettings
{
    ...
    ///
    ////////////////////////////////////////////////////////////
    explicit ContextSettings(Screen scr = TopScreen, unsigned int depth = 0, unsigned int stencil = 0, unsigned int antialiasing = 0, unsigned int major = 1, unsigned int minor = 1, unsigned int attributes = Default) :
    screen           (scr),
	depthBits        (depth),
    stencilBits      (stencil),
...
#endif // CPP3DS_CONTEXTSETTINGS_HPP
...
/// cpp3ds rendering (graphics module), so you may need to use
/// this structure only if you're using cpp3ds as a windowing
...
/// are not supported by the system; instead, cpp3ds will try to
