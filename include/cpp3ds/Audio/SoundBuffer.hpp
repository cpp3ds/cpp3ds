...
#ifndef CPP3DS_SOUNDBUFFER_HPP
#define CPP3DS_SOUNDBUFFER_HPP
...
public:
    ...
    ///
    /// See the documentation of cpp3ds::OutputSoundFile for the list
    /// of supported formats.
    ///
    ...
    /// (cpp3ds::Int16). The total number of samples in this array
...
#endif // CPP3DS_SOUNDBUFFER_HPP


////////////////////////////////////////////////////////////
/// \class cpp3ds::SoundBuffer
/// \ingroup audio
///
...
/// are like texture pixels, and a cpp3ds::SoundBuffer is similar to
/// a cpp3ds::Texture.
///
/// A sound buffer can be loaded from a file (see loadFromFile()
/// for the complete list of supported formats), from memory, from
/// a custom stream (see cpp3ds::InputStream) or directly from an array
/// of samples. It can also be saved back to a file.
///
/// Sound buffers alone are not very useful: they hold the audio data
/// but cannot be played. To do so, you need to use the cpp3ds::Sound class,
...
/// indeed a cpp3ds::SoundBuffer is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a cpp3ds::Sound is a lightweight object, which can use the audio data
...
/// several cpp3ds::Sound instances to the same cpp3ds::SoundBuffer.
///
/// It is important to note that the cpp3ds::Sound instance doesn't
/// copy the buffer that it uses, it only keeps a reference to it.
/// Thus, a cpp3ds::SoundBuffer must not be destructed while it is
/// used by a cpp3ds::Sound (i.e. never write a function that
/// uses a local cpp3ds::SoundBuffer instance for loading a sound).
///
/// Usage example:
/// \code
/// // Declare a new sound buffer
/// cpp3ds::SoundBuffer buffer;
///
/// // Load it from a file
...
/// \endcode
///
/// \see cpp3ds::Sound, cpp3ds::SoundBufferRecorder
///
////////////////////////////////////////////////////////////
