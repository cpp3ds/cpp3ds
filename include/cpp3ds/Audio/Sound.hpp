...
#ifndef CPP3DS_SOUND_HPP
#define CPP3DS_SOUND_HPP
...
public :
    ...
    /// thus the cpp3ds::SoundBuffer instance must remain alive as long
    ...
    /// to use it. It is called by the cpp3ds::SoundBuffer that
...
/// \ingroup audio
///
/// cpp3ds::Sound is the class to use to play sounds.
/// It provides:
...
///
/// cpp3ds::Sound is perfect for playing short sounds that can
/// fit in memory and require no latency, like foot steps or
/// gun shots. For longer sounds, like background musics
/// or long speeches, rather see cpp3ds::Music (which is based
/// on streaming).
///
/// In order to work, a sound must be given a buffer of audio
/// data to play. Audio data (samples) is stored in cpp3ds::SoundBuffer,
...
/// \endcode
///
/// \see cpp3ds::SoundBuffer, cpp3ds::Music
///
////////////////////////////////////////////////////////////
