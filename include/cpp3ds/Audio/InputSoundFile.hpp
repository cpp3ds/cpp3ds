...
#ifndef CPP3DS_INPUTSOUNDFILE_HPP
#define CPP3DS_INPUTSOUNDFILE_HPP
...
#endif // CPP3DS_INPUTSOUNDFILE_HPP


////////////////////////////////////////////////////////////
/// \class cpp3ds::InputSoundFile
/// \ingroup audio
///
/// This class decodes audio samples from a sound file. It is
/// used internally by higher-level classes such as cpp3ds::SoundBuffer
/// and cpp3ds::Music, but can also be useful if you want to process
/// or analyze audio files without playing them, or if you want to
/// implement your own version of cpp3ds::Music with more specific
/// features.
///
/// Usage example:
/// \code
/// // Open a sound file
/// cpp3ds::InputSoundFile file;
...
/// \endcode
///
/// \see cpp3ds::SoundFileReader, cpp3ds::OutputSoundFile
///
////////////////////////////////////////////////////////////
