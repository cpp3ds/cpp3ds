...
#ifndef CPP3DS_SOUNDSTREAM_HPP
#define CPP3DS_SOUNDSTREAM_HPP
...
#endif // CPP3DS_SOUNDSTREAM_HPP


////////////////////////////////////////////////////////////
/// \class cpp3ds::SoundStream
/// \ingroup audio
///
/// Unlike audio buffers (see cpp3ds::SoundBuffer), audio streams
...
///
/// cpp3ds::SoundStream is a base class that doesn't care about the
/// stream source, which is left to the derived class. cpp3ds provides
/// a built-in specialization for big files (see cpp3ds::Music).
...
/// Usage example:
/// \code
/// class CustomStream : public cpp3ds::SoundStream
/// {
/// public:
///
