...
#ifndef CPP3DS_SOUNDFILEREADERAAC_HPP
#define CPP3DS_SOUNDFILEREADERAAC_HPP
...
{
////////////////////////////////////////////////////////////
/// \brief Implementation of sound file reader that handles AAC encoded files
///
////////////////////////////////////////////////////////////
class SoundFileReaderAAC : public SoundFileReader
{
public:
...
private:
    ...
    std::vector<Uint8> m_inputBuffer;
    std::vector<Uint8> m_sampleBuffer;
    int m_inputBufferPosition;
    int m_sampleBufferPosition;
...
#endif // CPP3DS_SOUNDFILEREADERAAC_HPP
