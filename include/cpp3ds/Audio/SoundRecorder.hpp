...
#ifndef CPP3DS_SOUNDRECORDER_HPP
#define CPP3DS_SOUNDRECORDER_HPP
...
public :
    ...
    /// any attempt to use cpp3ds::SoundRecorder or one of its derived
    /// classes will fail.
    ///
...
#endif // CPP3DS_SOUNDRECORDER_HPP


////////////////////////////////////////////////////////////
/// \class cpp3ds::SoundRecorder
/// \ingroup audio
///
/// cpp3ds::SoundBuffer provides a simple interface to access
...
/// cpp3ds provides a built-in specialization for saving the
/// captured data to a sound buffer (see cpp3ds::SoundBufferRecorder).
///
...
/// Usage example:
/// \code
/// class CustomRecorder : public cpp3ds::SoundRecorder
/// {
...
/// \endcode
///
/// \see cpp3ds::SoundBufferRecorder
///
////////////////////////////////////////////////////////////
