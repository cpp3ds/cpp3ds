...
#ifndef CPP3DS_SOUNDFILEWRITER_HPP
#define CPP3DS_SOUNDFILEWRITER_HPP
...
#endif // CPP3DS_SOUNDFILEWRITER_HPP


////////////////////////////////////////////////////////////
/// \class cpp3ds::SoundFileWriter
/// \ingroup audio
///
/// This class allows users to write audio file formats not natively
/// supported by cpp3ds, and thus extend the set of supported writable
/// audio formats.
///
...
/// cpp3ds to find a suitable writer for a given filename.
///
/// To register a new writer, use the cpp3ds::SoundFileFactory::registerWriter
/// template function.
///
/// Usage example:
/// \code
