...
#ifndef CPP3DS_UDPSOCKET_HPP
#define CPP3DS_UDPSOCKET_HPP
...
/// interface uses packets (see cpp3ds::Packet), which are easier
/// to use and provide more safety regarding the data that is
/// exchanged. You can look at the cpp3ds::Packet class to get
...
/// cpp3ds::UdpSocket socket;
/// socket.bind(55001);
///
/// // Send a message to 192.168.1.50 on port 55002
/// std::string message = "Hi, I am " + cpp3ds::IpAddress::getLocalAddress().toString();
/// socket.send(message.c_str(), message.size() + 1, "192.168.1.50", 55002);
///
/// // Receive an answer (most likely from 192.168.1.50, but could be anyone else)
/// char buffer[1024];
/// std::size_t received = 0;
/// cpp3ds::IpAddress sender;
/// unsigned short port;
...
/// \endcode
///
/// \see cpp3ds::Socket, cpp3ds::TcpSocket, cpp3ds::Packet
///
////////////////////////////////////////////////////////////
