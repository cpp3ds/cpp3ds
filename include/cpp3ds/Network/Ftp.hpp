...
#ifndef CPP3DS_FTP_HPP
#define CPP3DS_FTP_HPP
...
public:
    ...
    public:
        ...
        enum Status
        {
            ...
            InvalidResponse  = 1000, ///< Not part of the FTP standard, generated by cpp3ds when a received response cannot be parsed
            ConnectionFailed = 1001, ///< Not part of the FTP standard, generated by cpp3ds when the low-level socket connection with the server fails
            ConnectionClosed = 1002, ///< Not part of the FTP standard, generated by cpp3ds when the low-level socket connection is unexpectedly closed
            InvalidFile      = 1003  ///< Not part of the FTP standard, generated by cpp3ds when a local file cannot be read or written
        };
    ...
    /// functions in the cpp3ds::Ftp class, this method can be used
...
/// \ingroup network
///
/// cpp3ds::Ftp is a very simple FTP client that allows you
...
/// cpp3ds::Ftp::Response to provide this data. The most often used
...
/// they are generated by cpp3ds when an internal error occurs.
///
...
/// cpp3ds::Ftp::Response response = ftp.connect("ftp://ftp.myserver.com");
/// if (response.isOk())
...
/// cpp3ds::Ftp::DirectoryResponse directory = ftp.getWorkingDirectory();
/// if (directory.isOk())
...
/// response = ftp.upload("local-path/file.txt", "files", cpp3ds::Ftp::Ascii);
/// if (response.isOk())
