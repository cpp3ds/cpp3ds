...
#ifndef CPP3DS_HTTP_HPP
#define CPP3DS_HTTP_HPP
...
/// \ingroup network
///
/// cpp3ds::Http is a very simple HTTP client that allows you
...
/// \li cpp3ds::Http::Request
/// \li cpp3ds::Http::Response
/// \li cpp3ds::Http
///
/// cpp3ds::Http::Request builds the request that will be
...
///
/// cpp3ds::Http::Response parse the response from the web server
/// and provides getters to read them. The response contains:
/// \li a status code
/// \li header fields (that may be answers to the ones that you requested)
/// \li a body, which contains the contents of the requested resource
///
/// cpp3ds::Http provides a simple function, SendRequest, to send a
/// cpp3ds::Http::Request and return the corresponding cpp3ds::Http::Response
/// from the server.
///
/// Usage example:
/// \code
...
/// cpp3ds::Http::Request request("features.php");
///
/// // Send the request
/// cpp3ds::Http::Response response = http.sendRequest(request);
///
/// // Check the status code and display the result
/// cpp3ds::Http::Response::Status status = response.getStatus();
