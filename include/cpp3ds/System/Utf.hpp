...
#ifndef CPP3DS_UTF_HPP
#define CPP3DS_UTF_HPP
...
public :
    ...
    /// specializations of the cpp3ds::Utf<> template, and allow
...
public :
    ...
    /// of cpp3ds::Utf<>, it is defined for convenience (it is used by
...
///
/// cpp3ds::Utf is a low-level, generic interface for counting, iterating,
...
///
/// cpp3ds::Utf<X> functions are all static, these classes are not meant to
/// be instantiated. All the functions are template, so that you
/// can use any character / string type for a given encoding.
///
/// It has 3 specializations:
/// \li cpp3ds::Utf<8> (typedef'd to cpp3ds::Utf8)
/// \li cpp3ds::Utf<16> (typedef'd to cpp3ds::Utf16)
/// \li cpp3ds::Utf<32> (typedef'd to cpp3ds::Utf32)
///
////////////////////////////////////////////////////////////
