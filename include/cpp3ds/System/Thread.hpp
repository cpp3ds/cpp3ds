...
#ifndef CPP3DS_THREAD_HPP
#define CPP3DS_THREAD_HPP
...
public :
    ...
    /// cannot survive after its cpp3ds::Thread instance is destroyed.
    ///
    ////////////////////////////////////////////////////////////
    ~Thread();
...
/// in parallel.
///
/// To use a cpp3ds::Thread, you construct it directly with the
/// function to execute as the entry point of the thread.
/// cpp3ds::Thread has multiple template constructors, which means
...
///
/// The function argument, if any, is copied in the cpp3ds::Thread
...
/// owner cpp3ds::Thread instance is destroyed before the
...
/// }
///
/// cpp3ds::Thread thread(&threadFunc, 5);
...
///
/// Task task;
/// cpp3ds::Thread thread(&Task::run, &task);
...
/// kind of situations, you can use mutexes (see cpp3ds::Mutex).
///
/// \see cpp3ds::Mutex
///
////////////////////////////////////////////////////////////
