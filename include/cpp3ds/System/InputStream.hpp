...
#ifndef CPP3DS_INPUTSTREAM_HPP
#define CPP3DS_INPUTSTREAM_HPP
...
///
/// SFML resource classes like cpp3ds::Texture and
/// cpp3ds::SoundBuffer provide loadFromFile and loadFromMemory functions,
/// which read data from conventional sources. However, if you
/// have data coming from a different source (over a network,
/// embedded, encrypted, compressed, etc) you can derive your
/// own class from cpp3ds::InputStream and load SFML resources with
