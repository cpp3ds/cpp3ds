...
#ifndef CPP3DS_THREADLOCALPTR_HPP
#define CPP3DS_THREADLOCALPTR_HPP
...
#include <cpp3ds/System/ThreadLocalPtr.inl>
...
////////////////////////////////////////////////////////////
/// \class cpp3ds::ThreadLocalPtr
/// \ingroup system
///
/// cpp3ds::ThreadLocalPtr is a type-safe wrapper for storing
...
/// MyClass object1;
/// MyClass object2;
/// cpp3ds::ThreadLocalPtr<MyClass> objectPtr;
///
/// void thread1()
/// {
...
///     cpp3ds::Thread t1(&thread1);
///     cpp3ds::Thread t2(&thread2);
///     t1.launch();
///     t2.launch();
///
///     return 0;
