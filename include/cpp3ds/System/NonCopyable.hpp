...
#ifndef CPP3DS_NONCOPYABLE_HPP
#define CPP3DS_NONCOPYABLE_HPP
...
/// in cpp3ds::NonCopyable so they will end up being inaccessible in both
...
/// and to use cpp3ds::NonCopyable when necessary to prevent
